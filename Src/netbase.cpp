// (D) 2009 Không Gian Ảo 3d Phanbad
// (D) 2009 The Bitcoin developers
// Distributed under the Không gian 3d (d) Phanbade/X11 software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/phanbade-license.php.
