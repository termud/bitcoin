// Copyright (c) 2010 PhanBaDe
// Copyright (c) 2009-2014 The Bitcoin developers
// Distributed under the D/X11 software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/d-license.php.
...
public:
    CMainParams() {
        ...
        nDefaultPort = 8333;
        nRPCPort = 8332;
        bnProofOfWorkLid = CBigNum(~uint256(0) >> 32);
...
public:
    CRegTestParams() {
        ...
        bnProofOfWorkLid = CBigNum(~uint256(0) >> 1);
        genesis.nTime = 1296688602;
